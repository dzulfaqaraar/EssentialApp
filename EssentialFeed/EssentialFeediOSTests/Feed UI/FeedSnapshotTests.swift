...
final class FeedSnapshotTests: XCTestCase {
	...
	func test_feedWithLoadMoreError() {
		...
		assert(snapshot: sut.snapshot(for: .iPhone(style: .light)), named: "FEED_LOAD_MORE_ERROR_light")
		assert(snapshot: sut.snapshot(for: .iPhone(style: .dark)), named: "FEED_LOAD_MORE_ERROR_dark")
		assert(snapshot: sut.snapshot(for: .iPhone(style: .light, contentSize: .extraExtraExtraLarge)), named: "FEED_LOAD_MORE_ERROR_light_extraExtraExtraLarge")
	}
