...
//
//  Created by Dzulfaqar on 20/12/22.
//
...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadingMoreIndicator_isVisibleWhileLoadingMore() {
        ...
        loader.completeLoadMoreWithError(at: 1)
        XCTAssertFalse(sut.isShowingLoadMoreFeedIndicator, "Expected no loading indicator once user initiated loading completes error")
    }
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        XCTAssertEqual(view?.isShowingRetryAction, true, "Expected retry action once first image loading completes with invalid image data")
    }
    ...
    func test_feedImageView_doesNotRenderLoadingImageWhenNotVisibleAnymore() {
        let (sut, loader) = makeSUT()
